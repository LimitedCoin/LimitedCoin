...
const string strMessageMagic = "LimitedCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "LimitedCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "maandag 7 september 2015 98a78502-1782-40f6-9eb6-eecd18e1d2f6";
        CTransaction txNew;
        txNew.nTime = 1441623389;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime = 1441623389;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce = 1090297 ;
		if(fTestNet)
        {
            block.nNonce = 1090297 ;
        }
		
		uint256 nhashMerkleRoot = uint256("0x5052b92f90f09d709c75847705699a3dad61f8c5c9277984befedd512f01a9d5");
